...
func renderRegions(root string, cmdRoot *cobra.Command, pluginPaths map[string]string) (map[string]string, error) {
	...
	return map[string]string{
		...
		"doctor-command":         renderCommandDetails(cmdRoot, []string{"restish doctor", "restish doctor api", "restish doctor plugin", "restish doctor migrate-v1"}),
		...
		"utility-commands":       renderCommandDetails(cmdRoot, []string{"restish cert", "restish content-types", "restish links", "restish version"}),
